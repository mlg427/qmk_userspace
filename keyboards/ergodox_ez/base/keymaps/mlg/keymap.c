...
[BASE] = LAYOUT_ergodox_pretty(
  ...
  KC_LSFT,         KC_Z,        KC_X,          KC_C,    KC_V,    KC_B,    KC_MPRV,              KC_TRNS,      KC_N,    KC_M,    KC_COMM, KC_DOT,    KC_SLSH,     KC_TRNS,
  MO(UTIL),        KC_TRNS,     KC_TRNS,       KC_LALT, KC_LGUI,                                                       KC_RGUI, KC_TRNS, KC_TRNS,   KC_TRNS,     KC_TRNS,
